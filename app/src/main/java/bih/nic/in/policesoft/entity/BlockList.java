...
public class BlockList implements KvmSerializable, Serializable {
    ...
    public static Class<BlockList> BLOCKLIST = BlockList.class;

    public BlockList(SoapObject obj, String capid, Context context){
        ...
        try {
            ...
            if(skey!=null){
                ...
                if(cap!=null && cap.equals(capid)){
                    this.Block_Code = _encrptor.Decrypt(obj.getProperty("BlockCode").toString(),skey);
                    this.Block_Name = _encrptor.Decrypt(obj.getProperty("BlockName").toString(),skey);
                    this.Status ="True";
