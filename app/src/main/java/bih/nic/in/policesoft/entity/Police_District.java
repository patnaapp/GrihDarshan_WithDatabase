...
public class Police_District implements KvmSerializable, Serializable {

	private static final long serialVersionUID = 1L;

	public static Class<Police_District> DISTRICT_CLASS = Police_District.class;
	...
	public Police_District(SoapObject obj) {
		...
		try {
		    ...
		    this._DistName = _encrptor.Decrypt(obj.getProperty("DistName").toString(), skey);
