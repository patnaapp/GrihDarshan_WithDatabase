...
public class AshaOther_ActivityAccpRjctAdapter extends RecyclerView.Adapter<AshaOther_ActivityAccpRjctAdapter.ViewHolder>
{
    ...
    public AshaOther_ActivityAccpRjctAdapter(Activity context, ArrayList<AshaWorkEntity> data, Financial_Year fyear, Financial_Month fmonth)
    {
