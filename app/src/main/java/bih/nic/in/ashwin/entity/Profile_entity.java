...
public class Profile_entity implements KvmSerializable, Serializable {

    public static Class<Profile_entity> PROFILE_CLASS = Profile_entity.class;

    private String a_Id, ASHAID,ASHAFacilitatorID,DistrictCode,DistrictName,BlockCode,BlockName,HSCCode,HSCName,Name,Name_Hn,Name_AsPerAadhaar,AadhaarNo,
                   BenAccountNo,IFSCCode,FHName,FHName_Hn,DateofBirth,DateofJoining,MobileNo,AlternateMobileNo;

    public Profile_entity(SoapObject sobj) {
