...
public class AshaFCReportAdapter extends RecyclerView.Adapter<AshaFCReportAdapter.ViewHolder>
{
    ...
    public AshaFCReportAdapter(Activity context, ArrayList<AshaReport_entity> data)
    {
    ...
    {
        View view = mInflater.inflate(R.layout.adaptor_asha_fc_report, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position)
    {
        ...
        holder.tv_username.setText(info.getName().toUpperCase()+" - "+info.getASHAFacilitatorID());
