...
public class FCSalByBhmMOIC_Entity implements KvmSerializable, Serializable {

    public static Class<Activity_entity> FcSalByBhm_CLASS = Activity_entity.class;
    ...
    public FCSalByBhmMOIC_Entity() {

    }
    public FCSalByBhmMOIC_Entity(SoapObject sobj) {
